...
Next.js 16 (App Router, Turbopack), TypeScript, Tailwind CSS 4, Motion for React, Lenis, React Three Fiber, zod. Fonts are self-hosted from Fontsource (Newsreader, Hanken Grotesk, Geist Mono).
...
| `src/lib` | Design constants, motion presets, Lenis provider, hooks, enquiry schema, media helpers |
