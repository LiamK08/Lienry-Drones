 ...
 *
 * From 1024: the tagline (an h2 on the H3 step) in columns 1-5 with the status line pinned to the
 * foot of the row, so both columns end on one line; the three link columns in 7-12, two grid
 * columns each, under muted label heads. Then 48, the wordmark on the display step, 32, a rule,
 * 16 and the legal row. Padding 64 top, 32 bottom.
 *
    ...
    <footer data-tone="sunken" className="page-x border-t border-hairline bg-sunken pb-6 pt-12 text-ink md:pb-8 md:pt-16">
      <Container>
        <div className="grid gap-y-8 md:gap-y-10 lg:grid-cols-12 lg:gap-x-6">
          <div data-col className="flex flex-col gap-4 lg:col-span-5 lg:justify-between">
          ...
          <nav data-col aria-label="Footer" className="lg:col-span-6 lg:col-start-7">
        ...
        <p aria-hidden="true" className="mt-10 max-w-none font-display text-display leading-none md:mt-12">
          Lienry Drones
        </p>
        <div className="mt-8 flex flex-col gap-3 border-t border-border-strong/40 pt-4 text-caption text-muted sm:flex-row sm:items-center sm:justify-between">
